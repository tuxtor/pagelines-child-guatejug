...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<?php the_terms( get_the_ID(), 'participant-roles', '<div class="cs-roles">Colabora en: ', ', ', '</div>' ); ?>
				...
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><a href="<?php echo home_url(); ?>/conferencistas/">&larr; Conferencistas</a></div>
				</div><!-- #nav-below -->
